...
```{r runPipe, result='asis', cache=TRUE}
...
In some real world applications it is desireable to have more control
over paramters used in the pipeline for different amplicons. 
